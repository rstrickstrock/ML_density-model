...
minMETRIC = dfStatistics[f'{metrictype}'].max()
minMETRIC = minMETRIC + 0.01*minMETRIC
...
axd["AllInOne"].set_xlim([minMETRIC, minMETRIC])
...
axd["Grid1296"].set_xlim([minMETRIC, minMETRIC])
...
axd["Grid2401"].set_xlim([minMETRIC, minMETRIC])
...
axd["Sobol1"].set_xlim([minMETRIC, minMETRIC])
...
axd["Sobol2"].set_xlim([minMETRIC, minMETRIC])
