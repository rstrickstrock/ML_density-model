...
print(f'Grid1296')
print(f'mean RMSE: {np.mean(subsetGrid1296[f'{metricX}'].to_numpy())}')
print(f'stddev RMSE: {np.std(subsetGrid1296[f'{metricX}'].to_numpy())}')
print(f'mean R2: {np.mean(subsetGrid1296[f'{metricY}'].to_numpy())}')
print(f'stddev R2: {np.std(subsetGrid1296[f'{metricY}'].to_numpy())}\n')
subsetGrid2401 = dfStatistics[dfStatistics["dataset"] == "Grid2401"]
print(f'Grid2401')
print(f'mean RMSE: {np.mean(subsetGrid2401[f'{metricX}'].to_numpy())}')
print(f'stddev RMSE: {np.std(subsetGrid2401[f'{metricX}'].to_numpy())}')
print(f'mean R2: {np.mean(subsetGrid2401[f'{metricY}'].to_numpy())}')
print(f'stddev R2: {np.std(subsetGrid2401[f'{metricY}'].to_numpy())}\n')
subsetSobol1 = dfStatistics[dfStatistics["dataset"] == "Sobol1"]
print(f'Sobol1')
print(f'mean RMSE: {np.mean(subsetSobol1[f'{metricX}'].to_numpy())}')
print(f'stddev RMSE: {np.std(subsetSobol1[f'{metricX}'].to_numpy())}')
print(f'mean R2: {np.mean(subsetSobol1[f'{metricY}'].to_numpy())}')
print(f'stddev R2: {np.std(subsetSobol1[f'{metricY}'].to_numpy())}\n')
subsetSobol2 = dfStatistics[dfStatistics["dataset"] == "Sobol2"]
print(f'Sobol2')
print(f'mean RMSE: {np.mean(subsetSobol2[f'{metricX}'].to_numpy())}')
print(f'stddev RMSE: {np.std(subsetSobol2[f'{metricX}'].to_numpy())}')
print(f'mean R2: {np.mean(subsetSobol2[f'{metricY}'].to_numpy())}')
print(f'stddev R2: {np.std(subsetSobol2[f'{metricY}'].to_numpy())}\n')
