...
axd["AllInOne"].scatter(subsetGrid1296["rmse"], subsetGrid1296["r2"], label="Grid1296", c="#332288", marker='o')#, edgecolor="#44AA99")
axd["AllInOne"].scatter(subsetGrid2401["rmse"], subsetGrid2401["r2"], label="Grid2401", c="#88CCEE", marker='o')#, edgecolor="#44AA99")
axd["AllInOne"].scatter(subsetSobol1["rmse"], subsetSobol1["r2"], label="Sobol1", c="#DDCC77", marker='o')#, edgecolor="#44AA99")
axd["AllInOne"].scatter(subsetSobol2["rmse"], subsetSobol2["r2"], label="Sobol2", c="#117733", marker='o')#, edgecolor="#44AA99")
axd["AllInOne"].legend()
...
axd["Grid1296"].scatter(subsetGrid1296["rmse"], subsetGrid1296["r2"], label="Grid1296", c="#332288", marker='o')#, edgecolor="#44AA99")
axd["Grid1296"].legend()
axd["Grid1296"].set(xlabel="RMSE", ylabel="R2")
axd["Grid1296"].set_title("Grid1296", fontweight='bold')
#axd["Grid1296"].set_xlim([minRMSE, maxRMSE])
#axd["Grid1296"].set_ylim([minR2, maxR2])

axd["Grid2401"].scatter(subsetGrid2401["rmse"], subsetGrid2401["r2"], label="Grid2401", c="#88CCEE", marker='o')#, edgecolor="#44AA99")
axd["Grid2401"].legend()
axd["Grid2401"].set(xlabel="RMSE", ylabel="R2")
axd["Grid2401"].set_title("Grid2401", fontweight='bold')
#axd["Grid2401"].set_xlim([minRMSE, maxRMSE])
#axd["Grid2401"].set_ylim([minR2, maxR2])

axd["Sobol1"].scatter(subsetSobol1["rmse"], subsetSobol1["r2"], label="Sobol1", c="#DDCC77", marker='o')#, edgecolor="#44AA99")
axd["Sobol1"].legend()
axd["Sobol1"].set(xlabel="RMSE", ylabel="R2")
axd["Sobol1"].set_title("Sobol1", fontweight='bold')
#axd["Sobol1"].set_xlim([minRMSE, maxRMSE])
#axd["Sobol1"].set_ylim([minR2, maxR2])

axd["Sobol2"].scatter(subsetSobol2["rmse"], subsetSobol2["r2"], label="Sobol2", c="#117733", marker='o')#, edgecolor="#44AA99")
axd["Sobol2"].legend()
axd["Sobol2"].set(xlabel="RMSE", ylabel="R2")
axd["Sobol2"].set_title("Sobol2", fontweight='bold')
#axd["Sobol2"].set_xlim([minRMSE, maxRMSE])
